...
export DPDK_PARAMS="-c 0x19 --master-lcore 3 -n 1 --socket-mem 512 --file-prefix pktgen --no-pci --vdev=net_virtio_user1,mac=00:00:00:00:00:01,path=/var/run/openvswitch/vhost-user1 --vdev=net_virtio_user2,mac=00:00:00:00:00:02,path=/var/run/openvswitch/vhost-user2"
