...
#--socket-mem 512: use 512M  per socket  
...
export DPDK_PARAMS="-c 0xE0 --master-lcore 5 -n 1 --socket-mem 512 --file-prefix testpmd --no-pci --vdev=net_virtio_user3,mac=00:00:00:00:00:03,path=/var/run/openvswitch/vhost-user3 --vdev=net_virtio_user4,mac=00:00:00:00:00:04,path=/var/run/openvswitch/vhost-user4"
